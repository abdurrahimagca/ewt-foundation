...
const emits = defineEmits<{
  (e: "update:modelValue", value: Entity<"product"> | null): void;
}>();
...
async function searchProduct() {
  ...
  try {
    ...
    const products = await fetchSwEntityCollection("product", criteria);
...
function selectProduct(product: Entity<"product">) {
  emits("update:modelValue", product);
...
function openProductDetail(productId: string) {
  const detailUrl = `http://ewt-shop.homelab-kaleici.space/admin#/sw/product/detail/${productId}`;
        ...
        <div class="selected-tags" v-if="modelValue">
          <div class="tag">
            <div class="product-info">
              ...
              <span class="product-number" v-if="modelValue.productNumber">
                Product #: {{ modelValue.productNumber }}
              </span>
            </div>
            <div class="tag-actions">
              <button
                class="info-button"
                @click.stop="openProductDetail(modelValue.id)"
          ...
          <div v-else-if="selectables.length > 0" class="options-list">
            ...
            >
              <div class="product-info">
                ...
                <span class="product-number" v-if="product.productNumber">
